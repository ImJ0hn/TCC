...
<body>
    ...
    <form method="POST" action="./update/salvarProdutos.php">
        <div class="right-produtoMobile">
            ...
            <div class="detalhes">
              <div class="content">
                ...
                <p>Preço</p>
                <input type="text" placeholder="Preço" name="preco"  value="<?php echo $preco;?>">
                <p>Descrição</p>
        ...
        <div class="left-produto">
            ...
            <h1>Produtos</h1>
              <div class="tab">
                <div class="tabs-duo">
                  <button id="WHYYY" class="tab-button-active" name="tab-buttons"><a href="produtos.php">Produtos</a></button>
...
?>
        ...
        <form method="POST" action="./update/salvarProdutos.php" class="right-produto">
        <div class="detalhes">
          <div class="content">
