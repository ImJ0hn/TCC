...
<body>
    ...
    <form method="POST" action="../inserir/inserirEstoque.php">
        <div class="right-produtoMobile">
            ...
            <div class="detalhes">
              ...
              <p></p>
            <h1>Adicionar</h1>
            <input type="hidden" class="input-formulario" name="id_estoque">
            <p>Nome do produto</p>
            <input type="text" placeholder="Nome do produto" name="nm_produto">
            <p>Qtde. no estoque</p>
            <input type="text" placeholder="Qde. no estoque" name="qt_estoque">
            <p>Descrição</p>
            ...
            <h1>Produtos</h1>
              <div class="tab">
                <div class="tabs-duo">
                  ...
                  <button id="WHYYY" class="tab-button" name="tab-buttons"><a href="AdicionarProdutos.php">Adicionar produtos</a></button>
                  <button class="tab-button" name="tab-buttons"><a href="../armazem.php">Estoque</a></button>
                  <button class="tab-button-active" name="tab-buttons"><a href="AdicionarEstoque.php">Adicionar no Estoque</a></button>
...
?>
        ...
        <form method="POST" action="../inserir/inserirEstoque.php" class="right-produto">
        <div class="detalhes">
          <div class="content">
