...
<body>
    ...
    <div class="main-produto">
        ...
        <form method="POST" action="update/salvarEstoque.php" class="right-produtoMobile">
          <div class="detalhes">
            <div class="content">
            
            <input type="hidden" class="input-formulario" name="id_estoque" value="<?php echo $id_estoque ?>">
            <p>Nome do produto</p>
            <input type="text" placeholder="Nome do produto" name="nm_produto" value=" <?php echo $nm_produto;?>">
            <p>Qtde. no estoque</p>
            <input type="text" placeholder="Qde. no estoque" name="qt_estoque"  value="<?php echo $qt_estoque;?>">
            <p>Descrição</p>
            <input type="text" placeholder="Descrição" name="descricao" value="<?php echo $descricao;?>">
            <p>Validade</p>
            <input type="date" placeholder="Validade" name="validade" value="<?php echo $validade;?>">
            ...
            <div class="lista">
              ...
              <div class="tab">
                <div class="tabs-duo">
                    ...
                    <button id="WHYYY" class="tab-button" name="tab-buttons"><a href="pagAdicionar/AdicionarProdutos.php">Adicionar produtos</a></button>
                    <button class="tab-button-active" name="tab-buttons"><a href="armazem.php">Estoque</a></button>
                    <button class="tab-button" name="tab-buttons"><a href="pagAdicionar/AdicionarEstoque.php">Adicionar no Estoque</a></button>
...
while($dadosEstoque = mysqli_fetch_assoc($rEstoque))
{
  echo "<div class='linha'>";
  echo "<div class='linha-titulo'>";
  
  echo "<p>". $dadosEstoque['nm_produto']."</p>";

  // echo "<p>". $dadosEstoque['descricao']. "</p>";
 // echo "<p>". $dadosProdutos['preco']. "</p>";
  //echo "<p>". $dadosProdutos['descricao']."</p>";
  
  echo "<a class='btn btn-primary' href='armazem.php?id=$dadosEstoque[id_estoque]'>
  ...
  echo "</div>";
  echo "<p>Qtde: ". $dadosEstoque['qt_estoque']."</p>";
  echo "<p>". $dadosEstoque['descricao']."</p>";
  echo "<p>Validade: ". $dadosEstoque['validade']."</p>";
...
?>
        ...
        <form method="POST" action="update/salvarEstoque.php" class="right-produto">
        <div class="detalhes">
          <div class="content">
